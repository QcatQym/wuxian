...
namespace wuxian
{
  public class WirelessSignalReceiver100Config : IBuildingConfig
  {
    public static string Id = "WirelessSignalReceiver100";
    public const string DisplayName = "LED-100base";
