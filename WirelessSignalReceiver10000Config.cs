...
namespace wuxian
{
  public class WirelessSignalReceiver10000Config : IBuildingConfig
  {
    public static string Id = "WirelessSignalReceiver10000";
    public const string DisplayName = "LED-10000base";
