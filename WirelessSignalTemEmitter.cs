...
namespace wuxian
{
  ...
  public class WirelessSignalTemEmitter : KMonoBehaviour, IIntSliderControl, ISim1000ms
  {
    [field: Serialize]
    ...
    public void Sim1000ms(float dt)
    {
      ...
      if (Grid.Mass[i] > 0f)
      {
        WirelessLogicValueChanged wirelessLogicValueChanged = new WirelessLogicValueChanged
        {
          ...
          Signal = (int)GameUtil.GetTemperatureConvertedFromKelvin(Grid.Temperature[i], GameUtil.temperatureUnit)
        };
